...
void GUI::drawWall(Wall ***wall, Brick **brick)
	{
		...
		for(int i=0;i<17 ;i++)
		{
			for(int j=0 ;j<17;j++)
			{
				//Brick *brick1= dynamic_cast<Brick*>(wall[i][j]);
				if(wall[i][j] != &brick[i][j] && wall[i][j]->getIsempty() == 0)
				{		
					sf::Texture texture1;
					if(!texture1.loadFromFile("/home/samin/Desktop/game_pos/q1.PNG")){}
				...
				if(wall[i][j] == &brick[i][j] && wall[i][j]->getIsempty() == 0){
				sf::Texture texture2;
				if(!texture2.loadFromFile("/home/samin/Desktop/game_pos/q3.PNG")){}
...
void GUI::drawBomberman(BomberMan *Man, bool iself)
	{
		...
		{		sf::Texture texture1;
				string address[4];
				string face;
				address[0] = "/home/samin/Desktop/game_pos/manFront.png";
				address[1] = "/home/samin/Desktop/game_pos/manRight.png";
				address[2] = "/home/samin/Desktop/game_pos/manLeft.png";
				address[3] = "/home/samin/Desktop/game_pos/manBack.PNG";
...
void GUI::drawBomb(Bomb* bomb)
	{
		sf::Texture texture;
		if(!texture.loadFromFile("/home/samin/Desktop/game_pos/bomb.png")){}
